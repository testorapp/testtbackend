...
# ==================== CORS ====================
# Use flask-cors for robust CORS handling (preflight, credentials, etc.)
CORS(
    app,
    ...
    origins=[
        ...
        "http://localhost:5500",
        "http://127.0.0.1:5500",
        "https://007shh2l-5001.uks1.devtunnels.ms"
    ],
...
if __name__ == '__main__':
    # Bind to 0.0.0.0 to allow external connections (VS Code Port Forwarding, LAN, etc.)
    app.run(
